  ...
  <div class="bg-light-bg py-12 min-h-screen">
    <div class="container mx-auto px-4">
      <div class="component-container mx-auto">
        <h1 class="text-3xl md:text-4xl font-bold mb-8 text-primary">Impressum</h1>
        
        <div class="bg-white rounded-lg shadow-md p-6 md:p-8">
          <h2 class="text-2xl font-semibold mb-6 text-primary">Angaben gemäß § 5 TMG</h2>
          
          <div class="space-y-6">
            <div>
              <h3 class="text-xl font-medium mb-2">Unternehmen</h3>
              <p>SorglosPflege UG (haftungsbeschränkt)</p>
            ...
            <div>
              <h3 class="text-xl font-medium mb-2">Kontakt</h3>
              <p>Telefon: +49 (0) 123 456 78</p>
              <p>E-Mail: info@sorglos-pflege.de</p>
            </div>
            
            <div>
              <h3 class="text-xl font-medium mb-2">Vertretungsberechtigte Person</h3>
              <p>Max Mustermann (Geschäftsführer)</p>
            </div>
            
            <div>
              <h3 class="text-xl font-medium mb-2">Registereintrag</h3>
            ...
            <div>
              <h3 class="text-xl font-medium mb-2">Umsatzsteuer-ID</h3>
              <p>Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz:</p>
              <p>DE123456789</p>
            </div>
            
            <div>
              <h3 class="text-xl font-medium mb-2">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h3>
              <p>Max Mustermann</p>
              <p>SorglosPflege UG (haftungsbeschränkt)</p>
              <p>Musterstraße 123</p>
              <p>12345 Berlin</p>
            ...
            <div>
              <h3 class="text-xl font-medium mb-2">Streitschlichtung</h3>
              <p>
            ...
            <div>
              <h3 class="text-xl font-medium mb-2">Haftung für Inhalte</h3>
              <p>
            ...
            <div>
              <h3 class="text-xl font-medium mb-2">Haftung für Links</h3>
              <p>
            ...
            <div>
              <h3 class="text-xl font-medium mb-2">Urheberrecht</h3>
              <p>
